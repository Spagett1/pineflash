use eframe::{egui::{TopBottomPanel, self,  menu, Button}};

use crate::{Flasher, FlashSavedConfig};
            ...
            menu::bar(ui, |ui|{
                ...
                ui.with_layout(egui::Layout::right_to_left(egui::Align::TOP), |ui| {
                    ...
                    if ui.add(Button::new(
                        ...
                        if let Err(..) = confy::store("PineFlash", None, FlashSavedConfig {
                            dark_mode: self.saved_config.dark_mode
                        }) {
                            self.config.logs.push_str("Pineflash: Failed to save the app state.")
                        }
                    }
                })
                // })
